...
import ChoferesM from "./choferes_m";

export default class Choferes extends React.Component {
    ...
    render() {
        return (
            ...
            <div>   {console.log(...this.props+"")} 
                <Card>
                    <CardHeader>
                        <span className="text-uppercase bold">Choferes</span>
                    ...
                    <CardBody className="pdg-5">
                        <Fils {...this.props}
                              ...
                              cols={[
                                  ...
                                  {name: 'dni', value: 'DNI'},
                                  {name: 'placa', value: 'Vehiculo Asignado'},
                ...
                <ChoferesM ref={instance => this.modal = instance}
