...
export default class DefaultAside extends Component {
                    ...
                    <TabPane tabId={1}>
                        <ListGroup className="list-group-accent">
                            ...
                            <ListGroupItem action tag="a" href="#"
                                ...
                                <small className="text-muted"><i className="icon-home"/>&nbsp; creativeLabs HQ
                                </small>
                    ...
                    <TabPane tabId={3} className="p-3">
                        ...
                        <div className="aside-options">
                            <div className="clearfix mt-4">
                                <small><b>Colapsar menu lateral</b></small>
                                <AppSwitch className={'float-right'} variant={'pill'} label color={'success'}
                                           defaultChecked size={'sm'}/>
                            </div>
                            <div>
                                <small className="text-muted">
                                    Menu lateral siempre colapsado al ingresar al sistema.
                                </small>
                            </div>
                        </div>
